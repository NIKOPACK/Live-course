/**
 * LiveCourse Agent — SSE transport endpoint.
 *
...
const log = createLogger('LiveCourse Agent');
...
export async function POST(req: NextRequest) {
  ...
  // Resolve via the 'livecourse-agent' stage so operators can route the editor agent
  ...
  // independent of the `livecourse-agent` conversation model that drives streamFn below.
