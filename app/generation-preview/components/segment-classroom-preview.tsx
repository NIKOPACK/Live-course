...
export function SegmentClassroomPending({
  message,
  busy = true,
}: {
  message: string;
  ...
  return (
    <div data-testid="segment-classroom-pending" data-readonly="true" className="min-w-0">
      ...
      <div
        ...
        aria-busy={busy}
        className={cn(
          'relative flex aspect-video w-full flex-col items-center justify-center gap-2 overflow-hidden rounded-lg bg-muted px-3 text-center sm:px-6',
          busy && 'lc-active-sheen',
        )}
      >
