...
// Outline: Streams real outline data as it arrives from SSE. Read-only — the
// learner watches the lesson skeleton take shape; review/editing of outlines is
// not part of the product (docs/spec/02 生成预览节).
function StreamingOutlineVisualizer({ outlines }: { outlines: SceneOutline[] }) {
  return (
    <motion.div
      ...
      className={cn(
        'relative h-52 w-44 overflow-hidden rounded-2xl border p-3 text-left',
