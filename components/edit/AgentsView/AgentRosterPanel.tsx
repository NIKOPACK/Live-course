  ...
  return (
    <span
      ...
      className={cn(
        ...
        'hover:underline hover:decoration-dashed hover:decoration-[#8eaae6]',
    ...
    >
      ...
      {open && (
        <div
          ...
          style={{ borderTop: '1px solid #e4ebfb', paddingTop: 12, background: '#fafcff' }}
        >
          {showAvatarPicker && (
            <div className="pb-1">
              <AvatarPicker
    ...
    <div className="flex flex-1 min-h-0 flex-col">
      ...
      <div className="flex flex-1 min-h-0 flex-col overflow-y-auto px-3 pb-4">
        ...
        <button
          ...
          onMouseEnter={(e) => {
            (e.currentTarget as HTMLButtonElement).style.borderColor = '#638be3';
            (e.currentTarget as HTMLButtonElement).style.color = '#1f4aa8';
