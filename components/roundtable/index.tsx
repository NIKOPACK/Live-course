...
interface RoundtableProps {
  ...
  readonly showTeacherIdentity?: boolean;
...
export function Roundtable({
  ...
  const ttsControlsEnabled = isLiveCourseTTSEnabled() && ttsEnabled;
  ...
  const toolbar = (
    <CanvasToolbar
      ...
      ttsEnabled={ttsControlsEnabled}
      showTtsControls={isLiveCourseTTSEnabled()}
      ttsMuted={ttsMuted}
      ttsVolume={ttsVolume}
      onToggleMute={() => ttsControlsEnabled && setTTSMuted(!ttsMuted)}
      onVolumeChange={(v) => {
        if (ttsControlsEnabled) setTTSVolume(v);
      }}
  ...
  return (
    <div
      className={cn(
        'relative z-10 flex h-[168px] w-full flex-col transition-all duration-300',
    ...
    >
      ...
      <div className="flex-1 flex items-stretch min-h-0">
        ...
        <div
          className={cn(
            'relative flex w-[90px] shrink-0 flex-col overflow-visible border-r border-gray-100/50 bg-white/40 transition-opacity duration-300 dark:border-gray-700/50 dark:bg-gray-900/40',
            !showTeacherIdentity && 'hidden',
            isPresenting && !controlsVisible && 'opacity-0 pointer-events-none',
          )}
        >
        ...
        <div className="relative mx-3 mb-2 min-w-0 flex-1">
          ...
          <div
            ...
            className="group relative flex h-full w-full cursor-default flex-col justify-center overflow-hidden rounded-md border border-gray-200/80 bg-white px-5 shadow-sm transition-all duration-500 dark:border-gray-700 dark:bg-gray-900"
          >
            {/* Text input box */}
            <AnimatePresence>
              {isInputOpen && (
                <motion.div
                  ...
                  className="absolute inset-x-6 bottom-2 z-20 flex items-center justify-end"
                >
                  <div
                    data-testid="roundtable-non-presentation-input-panel"
                    className="relative flex w-fit min-w-[200px] max-w-[85%] items-end gap-2 rounded-2xl rounded-br-none border border-purple-200 bg-white/90 px-2 shadow-2xl ring-1 ring-purple-100/50 backdrop-blur-md sm:min-w-[300px] sm:max-w-[65%] dark:border-purple-700 dark:bg-gray-800/90 dark:ring-purple-800/50"
                  >
        ...
        <div
          className={cn(
            'flex w-[140px] shrink-0 flex-col overflow-visible border-l border-gray-100/70 bg-gray-50/50 py-3 transition-opacity duration-300 dark:border-gray-700/70 dark:bg-gray-950/40',
            isPresenting && !controlsVisible && 'opacity-0 pointer-events-none',
          )}
        >
          ...
          <div className="flex min-h-0 flex-1 items-center justify-center gap-3 px-2">
            ...
            >
              ...
              >
                ...
                />
                <div className="relative z-10 size-14 overflow-hidden rounded-full border border-gray-100 bg-gray-50 text-2xl shadow-sm dark:border-gray-700 dark:bg-gray-800">
                  <AvatarDisplay src={userAvatar} alt={t('roundtable.you')} />
                </div>
                <div className="absolute right-0 top-0 z-20 flex size-5 items-center justify-center rounded-full border border-gray-100 bg-white shadow-md dark:border-gray-700 dark:bg-gray-800">
                  <div
                    className={cn(
                      'w-1.5 h-1.5 rounded-full',
