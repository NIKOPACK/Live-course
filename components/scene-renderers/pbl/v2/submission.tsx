 ...
 *   persisted to IndexedDB by the LiveCourse stage layer. The Modal's
...
function SubmissionModal({
  ...
  const handleFile = async (file: File) => {
    ...
    abortRef.current = ac;
    // Image / screenshot: store via LiveCourse's existing object storage
    ...
    // PDF: parse to text via LiveCourse's existing /api/parse-pdf (reused, not
