...
import type { PPTImageElement } from '@livecourse/dsl';
...
export interface BaseImageElementProps {
  ...
  /** Hide all mutation affordances on replay's read-only presentation surface. */
 ...
 */
export function BaseImageElement({ elementInfo, presentationOnly = false }: BaseImageElementProps) {
  const { t } = useI18n();
