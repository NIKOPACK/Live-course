...
/**
 * Shared thumbnail content. HTML pages use their actual isolated document;
 * legacy scenes retain their previous slide render or illustration.
 *
...
export function SceneThumbnailContent({
  ...
  if (
    (scene.content.type === 'quiz' || scene.content.type === 'interactive') &&
    scene.content.html
  ) {
    return visible ? (
      <HtmlPagePreview
      ...
      <div className="h-full w-full bg-muted" aria-label={scene.title} />
    );
  }
