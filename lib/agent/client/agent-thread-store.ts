 ...
 * single-thread localStorage store ('livecourse-agent-threads') is migrated once via
...
const LEGACY_KEY = 'livecourse-agent-threads';
const ACTIVE_KEY = 'livecourse-agent-active-session';
