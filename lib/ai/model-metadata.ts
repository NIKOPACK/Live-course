...
const THINKING_CAPABILITIES: Record<string, ThinkingCapability> = {
  ...
  // aiping is an OpenAI-compatible gateway proxying each model's native
  // reasoning family, so each entry reuses the same transport as the origin
  ...
  [getModelMetadataKey('grok', 'grok-4.20-0309-reasoning')]: fixedThinkingCapability,
