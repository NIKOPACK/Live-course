...
export const PROVIDERS: Record<ProviderId, ProviderConfig> = {
  ...
  grok: {
    ...
    models: [
      ...
      },
      {
        ...
        name: 'Grok 4.20 0309 Reasoning (Compatible Endpoint)',
      },
      {
        id: 'grok-4.20-0309-non-reasoning',
        name: 'Grok 4.20 0309 Non-Reasoning (Compatible Endpoint)',
      },
      {
        id: 'grok-composer-2.5-fast',
        name: 'Grok Composer 2.5 Fast (Compatible Endpoint)',
      },
      {
        id: 'grok-4.20',
        name: 'Grok 4.20',
  ...
  aiping: {
    ...
    name: 'AI Ping',
    type: 'openai',
    defaultBaseUrl: 'https://aiping.cn/api/v1',
    requiresApiKey: true,
    icon: '/logos/aiping.png',
    models: [
      {
