 ...
 *
 * The type itself lives in `@livecourse/dsl` (it is part of the persisted
 ...
 */
import type { VoiceDesign } from '@livecourse/dsl';

export type { VoiceDesign } from '@livecourse/dsl';
