 ...
 */
const PRESENCE_CHANNEL = 'livecourse-stage-presence';
// BroadcastChannel delivery can cross a worker/process boundary. A 60 ms window
// produced false "absent" results on a busy two-core CI runner, which is unsafe
// for the ownership check this protocol protects.
