...
- **Scene count**: Choose nodes for a complete learning progression, not a fixed page or minute quota. Include a realistic `estimatedDuration` in seconds, including practice and checkpoints; this is an estimate, not a content cap. Preserve essential explanations, examples and selected topics. Avoid repeating the same concept just to fill pages.
