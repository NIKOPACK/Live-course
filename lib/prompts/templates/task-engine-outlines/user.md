...
If the request is not suitable, generate a normal LiveCourse-style outline using slide plus ordinary interactive widgets only. Do not output `procedural-skill` for non-vocational topics.
