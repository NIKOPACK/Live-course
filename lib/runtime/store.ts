...
/**
 * Lazy app-wide RuntimeStore singleton (#869). One `livecourse-runtime` IndexedDB
...
const RUNTIME_DB_NAME = 'livecourse-runtime';
 ...
 * (`livecourse-runtime`), so a broken or hung runtime DB must not brick stage
