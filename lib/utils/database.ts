...
const DATABASE_NAME = 'LiveCourse-Database';
const _DATABASE_VERSION = 16;

/**
 * LiveCourse Database Instance
 */
class LIVECOURSEDatabase extends Dexie {
  // Table definitions
...
export const db = new LIVECOURSEDatabase();
