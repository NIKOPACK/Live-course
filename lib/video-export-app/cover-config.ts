...
export function getVideoExportCoverLabels(locale: string): CoverCardLabels {
  const resource =
    locale in LOCALE_RESOURCES ? LOCALE_RESOURCES[locale as Locale] : LOCALE_RESOURCES['en-US'];
