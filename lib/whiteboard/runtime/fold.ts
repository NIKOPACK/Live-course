import { validateRuntimeRecord, type RuntimeRecord, type Whiteboard } from '@livecourse/dsl';
...
const RUNTIME_WHITEBOARD_ID_NAMESPACE = 'livecourse.whiteboard-runtime-board.v1';
