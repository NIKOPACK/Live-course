/**
 * @livecourse/dsl — the pure, dependency-free contract keystone for the LiveCourse SDK family.
 *
 ...
 * under `@livecourse/dsl/schema/*`; the pure `validate*` / `normalize*` functions
