/**
 * The LiveCourse slide object model — the canonical, dependency-free contract.
 *
 * This file is the single source of truth that supersedes the three copies that
 * had drifted apart before @livecourse/dsl existed:
 *   - app:      lib/types/slides.ts
 *   - renderer: packages/@livecourse/renderer/src/types/slides.ts
 *   - importer: packages/@livecourse/importer/src/livecourse/types/slides.ts
 *
