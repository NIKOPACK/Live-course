 ...
 *
 * The split keeps `@livecourse/dsl` focused on the lesson skeleton while letting the
...
export interface QuizContent {
  ...
  /** Model-authored presentation; structured questions remain the grading authority. */
  html?: string;
}
