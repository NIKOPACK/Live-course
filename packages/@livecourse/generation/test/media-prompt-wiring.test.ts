...
import { generateSceneOutlinesFromRequirements } from '@livecourse/generation';
import { generateSceneContent } from '@livecourse/generation';
import type { SceneOutline, UserRequirements } from '@livecourse/generation';
import type { AICallFn } from '@livecourse/generation';
