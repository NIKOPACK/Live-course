...
import { generatePBLV2ProjectSingleCall, type AICallFn } from '@livecourse/generation';
...
describe('PBL planner re-seat proof', () => {
  it('produces the same normalized project through app and package call seams', () => {
    ...
    const program = `
      ...
      import { generatePBLV2ProjectSingleCall as packageGenerate } from './packages/@livecourse/generation/src/index.ts';
