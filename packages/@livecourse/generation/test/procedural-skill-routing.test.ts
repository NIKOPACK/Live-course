...
import { generateSceneContent, generateWidgetContent } from '@livecourse/generation';
import type { AICallFn } from '@livecourse/generation';
import type { GeneratedInteractiveContent, SceneOutline } from '@livecourse/generation';
