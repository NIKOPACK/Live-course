...
import type { Slide, PPTElement, PPTImageElement, PPTVideoElement } from '@livecourse/dsl';
 ...
 * representation (L0, which belongs in @livecourse/dsl). L1 normalizes down to L0.
 */
