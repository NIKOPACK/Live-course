/**
 * @livecourse/storage — the LiveCourse pluggable persistence layer.
 *
 * Dependency arrow (kept acyclic): `@livecourse/storage -> @livecourse/dsl` only.
...
export {
  COURSE_PLAN_SCHEMA_VERSION,
  CoursePlanMigrationError,
  assertReadableCoursePlan,
...
export type { AssetRef, AssetMeta, BinaryBlob, StorageProvider } from '@livecourse/dsl';
