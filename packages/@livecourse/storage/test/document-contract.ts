...
import { DSL_VERSION } from '@livecourse/dsl';
import type { Scene } from '@livecourse/dsl';
import { DocumentVersionError, type DocumentStore, type LiveCourseDocument } from '../src/index.js';
...
export function makeDocument(stageId = 'stage-1'): LiveCourseDocument {
  return {
