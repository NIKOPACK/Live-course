...
describe('OpenAI provider defaults', () => {
  ...
  it.each([
    ['grok-4.20-0309-reasoning', 'Grok 4.20 0309 Reasoning (Compatible Endpoint)'],
    ['grok-4.20-0309-non-reasoning', 'Grok 4.20 0309 Non-Reasoning (Compatible Endpoint)'],
    ['grok-composer-2.5-fast', 'Grok Composer 2.5 Fast (Compatible Endpoint)'],
  ])('includes CC Switch-compatible Grok model %s', (modelId, name) => {
    expect(getModelInfo('grok', modelId)).toMatchObject({ id: modelId, name });
  });
