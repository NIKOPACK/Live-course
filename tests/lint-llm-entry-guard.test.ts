 ...
 * `@livecourse` package directories excluded from the dynamic-import ban, and both
...
const GUARDED_PATHS = [
  ...
  'app/api/probe/route',
  'components/probe',
  'packages/@livecourse/renderer/src/probe',
  'packages/@livecourse/storage/src/probe',
  'packages/@livecourse/generation/src/probe',
...
describe('LLM entry-point lint guard — coverage matrix', () => {
  ...
  it('still enforces the pre-existing module boundaries it shares a rule key with', async () => {
    ...
    for (const filePath of [
      'packages/@livecourse/renderer/src/probe.ts',
      'packages/@livecourse/storage/src/probe.ts',
      'packages/@livecourse/generation/src/probe.ts',
