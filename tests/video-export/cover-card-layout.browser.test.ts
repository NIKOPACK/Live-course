...
const DEFAULT_CTA = resolveVideoExportCta('courses.example.com')!;
  ...
  try {
    ...
    const runtime = await page.evaluate(() => {
      ...
      return {
        ...
        livecourseTimeline: typeof globals.__timelines?.livecourse?.duration === 'function',
      };
    });
    ...
    expect(runtime).toEqual({
      gsap: 'object',
      timelineKeys: ['livecourse'],
      livecourseTimeline: true,
    });
  } finally {
