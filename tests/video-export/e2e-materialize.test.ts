...
const DEFAULT_SAMPLE_LOCALE = 'en-US';
const DEFAULT_SAMPLE_CTA = resolveVideoExportCta('courses.example.com');
...
describe.skipIf(!OUT_DIR)('materialize a Hyperframes project for real-CLI E2E', () => {
  it('writes a complete, self-contained project', () => {
    ...
    expect(DEFAULT_SAMPLE_CTA).toEqual({ destination: 'courses.example.com' });
